...
EXPECTED_UUID_COLUMNS = {
    ...
    ("employee_employments", "tenant_id"),
...
EXPECTED_CHECK_CONSTRAINTS = {
    ...
    "ck_employee_employments_version_positive",
    "ck_employee_employments_work_type",
    "ck_employee_profiles_version_positive",
...
EXPECTED_NAMED_UNIQUE_CONSTRAINTS = {
    ...
    "uq_employee_employments_tenant_employee_id",
    "uq_employee_employments_tenant_id_id",
    "uq_employee_profiles_tenant_employee_id",
    "uq_employee_profiles_tenant_id_id",
