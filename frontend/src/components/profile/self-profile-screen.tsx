...
import {
  ...
  type SelfEmployeeProtectedValue,
...
function ProtectedProfileValue({
  value,
}: {
  ...
  return (
    <span className={styles.protectedValue}>
      ...
      <small>
        {value.visibility === "masked" ? "Maskeli" : "Kullanılamıyor"}
      </small>
    </span>
  );
}
      ...
      <div className={styles.sectionGrid}>
        <section className={styles.profileSection} aria-labelledby="self-personal-title">
          ...
          <dl className={styles.metadataGrid}>
            ...
            <div>
              <dt>Doğum tarihi</dt>
              <dd><ProtectedProfileValue value={profile.personal.birth_date} /></dd>
            </div>
            <div>
              <dt>Telefon</dt>
              <dd><ProtectedProfileValue value={profile.personal.phone} /></dd>
            </div>
            <div><dt>İş e-postası</dt><dd>{profile.core.email ?? "Eklenmemiş"}</dd></div>
          </dl>
          <p className={styles.maskingNote} role="note">
            Kişisel alanlar güvenli profil politikasına göre maskeli veya kullanılamıyor
            olarak gösterilir. Bu görünümde ayrıntıları açma özelliği bulunmaz.
          </p>
        </section>
